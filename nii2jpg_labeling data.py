...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 22 22:39:38 2022
...
def main(argv):
    inputfile = "CT_lung/Task08_HepaticVessel-004/Task08_HepaticVessel/labelsTr/hepaticvessel_266.nii.gz"
    outputfile = 'ipg6'
    try:
    ...
    image_array, meta = LoadImage()("CT_lung/Task06_Lung/labelsTr/lung_003.nii.gz")
        ...
        for current_volume in range(0, total_volumes):
            ...
            for current_slice in range(0, total_slices):
                if (slice_counter % 1) == 0:
                    ...
                    image_name = "img_z" + "{:0>3}".format(str(current_slice+1))+ ".png"
